...
final class Orion_Role_Registry {
    ...
    private const ALIASES = array(
        'primarycoating' => 'primary_coating',
        'primaryproduct' => 'primary_product',
        'mainpaint' => 'primary_coating',
        'maskingtape' => 'masking_tape',
        'masking' => 'masking_tape',
        'dustsheet' => 'dust_sheet',
        'rollerframe' => 'roller',
        'rollersleeve' => 'roller',
        'sleeve' => 'roller',
        'frame' => 'roller',
    ...
    private const OPTIONAL = array(
        'primer', 'cleaner', 'filler', 'roller', 'brush', 'tray',
        'masking_tape', 'dust_sheet', 'sandpaper', 'scraper',
        'fixings', 'trim', 'tools', 'protection',
    );
    ...
    public static function canonical(string $role): string {
        $key = strtolower((string) preg_replace('/[^a-z0-9_-]/', '', $role));
