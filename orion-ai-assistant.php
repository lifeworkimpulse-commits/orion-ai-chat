 ...
 */
if(!defined('ABSPATH')){exit;}define('ORION_AI_VERSION','0.10.0');define('ORION_AI_SCHEMA_VERSION','0.8.0');define('ORION_AI_FILE',__FILE__);define('ORION_AI_DIR',plugin_dir_path(__FILE__));define('ORION_AI_URL',plugin_dir_url(__FILE__));
foreach(array('class-orion-settings.php','class-orion-environment.php','class-orion-cleanup.php','interface-orion-ai-provider.php','class-orion-openrouter-client.php','class-orion-gemini-client.php','class-orion-resilient-provider.php','class-orion-ai-provider-factory.php','class-orion-knowledge-base.php','class-orion-product-search.php','class-orion-catalogue-audit.php','class-orion-rate-limiter.php','class-orion-conversation-service.php','class-orion-intent-classifier.php','class-orion-context-manager.php','class-orion-semantic-product-planner.php','class-orion-manager-handoff.php','class-orion-trace-service.php','class-orion-diagnostics-service.php','class-orion-evaluation-service.php','class-orion-chat-orchestrator.php','class-orion-rest-controller.php','class-orion-admin-controller.php','class-orion-ai-assistant.php','class-orion-cli-command.php')as$file)require_once ORION_AI_DIR.'includes/'.$file;
