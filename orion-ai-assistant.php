 ...
 */
if(!defined('ABSPATH')){exit;}define('ORION_AI_VERSION','0.10.2');define('ORION_AI_SCHEMA_VERSION','0.8.0');define('ORION_AI_FILE',__FILE__);define('ORION_AI_DIR',plugin_dir_path(__FILE__));define('ORION_AI_URL',plugin_dir_url(__FILE__));
