...
- Added structured product-fact extraction for functions, surfaces, included components, roller/tray widths and explicit coverage evidence.
...
- Added unit tests for role aliases, delivery routing, dimensions, roller evidence, compatible systems and tray width.
